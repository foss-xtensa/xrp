/* This linker script generated from xt-genldscripts.tpp for LSP /home/rajivr/MultiCoreWare/MP/emul/sys-x86-linux/subsys.xtsys/package/cores/P6_0/xtensa-elf/lib/xt2000 */
...
MEMORY
{
  ...
  sysram_B13_seg :                    	org = 0x60000340, len = 0xF7FCC0
}
...
_memmap_seg_sysram_B13_max   = 0x60f80000;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x60f80000);
  _heap_sentry = 0x60f80000;
  .debug  0 :  { *(.debug) }
  .line  0 :  { *(.line) }
