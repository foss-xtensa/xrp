/* This linker script generated from xt-genldscripts.tpp for LSP /home/rajivr/MultiCoreWare/MP/emul/sys-x86-linux/subsys.xtsys/package/cores/P6_1/xtensa-elf/lib/min-rt-local */
...
MEMORY
{
  ...
  sysrom_D0_seg :                     	org = 0x50400000, len = 0x1FFD00
  sysrom_D1_seg :                     	org = 0x505FFD00, len = 0x300
  sysrom_E0_seg :                     	org = 0x50600004, len = 0x4
...
_memmap_mem_sysrom_D_start = 0x50400000;
_memmap_mem_sysrom_D_end   = 0x50600000;
_memmap_mem_sysrom_E_start = 0x50600004;
_memmap_mem_sysrom_E_end   = 0x50600008;
...
_memmap_seg_sysrom_D0_start = 0x50400000;
_memmap_seg_sysrom_D0_max   = 0x505ffd00;
_memmap_seg_sysrom_D1_start = 0x505ffd00;
_memmap_seg_sysrom_D1_max   = 0x50600000;
_memmap_seg_sysrom_E0_start = 0x50600004;
_memmap_seg_sysrom_E0_max   = 0x50600008;
...
_memmap_cacheattr_wb_base = 0x10001141;
_memmap_cacheattr_wt_base = 0x30003343;
_memmap_cacheattr_bp_base = 0x40004444;
_memmap_cacheattr_unused_mask = 0x0FFF0000;
...
_memmap_cacheattr_wb_strict = 0x10001141;
_memmap_cacheattr_wt_strict = 0x30003343;
_memmap_cacheattr_bp_strict = 0x40004444;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x3ff80000);
  _heap_sentry = 0x3ff80000;
