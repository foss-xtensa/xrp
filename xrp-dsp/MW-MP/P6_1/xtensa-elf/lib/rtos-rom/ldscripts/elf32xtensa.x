/* This linker script generated from xt-genldscripts.tpp for LSP /home/rajivr/MultiCoreWare/MP/sys-x86-linux/subsys.xtsys/package/cores/P6_1/xtensa-elf/lib/rtos-rom */
...
SECTIONS
{
  ...
  .text 0x74000340 : AT(LOADADDR(.sysrom.text) + ((SIZEOF(.sysrom.text) + 3) & 0xFFFFFFFC)) ALIGN(4)
  {
    _stext = .;
