/* This linker script generated from xt-genldscripts.tpp for LSP /home/rajivr/MultiCoreWare/MP/sys-x86-linux/subsys.xtsys/package/cores/P6_0/xtensa-elf/lib/rtos-rom */
/* Linker Script for default link */
/*  Customer ID=4313; Build=0x61693; Copyright (c) 2005-2016 Tensilica Inc.  */
/*
...
SECTIONS
{
  ...
  .text 0x70000340 : AT(LOADADDR(.sysrom.text) + ((SIZEOF(.sysrom.text) + 3) & 0xFFFFFFFC)) ALIGN(4)
  {
    _stext = .;
  ...
  .data : AT(LOADADDR(.text) + (ADDR(.data) - ADDR(.text))) ALIGN(4)
  {
  ...
  .dram1.rodata : AT(LOADADDR(.data) + ((SIZEOF(.data) + 3) & 0xFFFFFFFC)) ALIGN(4)
  {
